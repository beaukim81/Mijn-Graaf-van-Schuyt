      ...
      <summary className="item-card__header collapsible-card__summary">
        <div>
          ...
          <div className="resident-byline">
            ...
            <ResidentIdentity anonymizeWhenProfileMissing={!request.aangemaakt_door} compact houseNumber={request.aanmaker_huisnummer} name={request.aanmaker_naam} profile={profilesByUserId.get(request.aangemaakt_door)} />
          </div>
        </div>
        ...
        <div className="neighbor-box">
          ...
          {request.offers.map((offer) => (
            <div className="neighbor-offer" key={offer.id}>
              ...
              <ResidentIdentity anonymizeWhenProfileMissing={!offer.helper_id} compact houseNumber={offer.helper_house_number} name={offer.helper_name} profile={profilesByUserId.get(offer.helper_id)} />
