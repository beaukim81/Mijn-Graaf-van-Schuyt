...
begin
  ...
  delete from storage.objects where bucket_id = 'bulletin-images' and owner = current_user_id;
...
begin
  ...
  delete from storage.objects where bucket_id = 'bulletin-images' and owner = target_user_id;
